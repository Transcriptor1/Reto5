 ...
 */
package com.mycompany.reto5grupo66.modelo.VO;
...
public class Proyecto {
    ...
    public String toString() {
        return "Proyecto{" + "id_proyecto=" + id_proyecto + ", constrcutora=" + constructora + ", numero_habitaciones=" + numero_habitaciones + ", ciudad=" + ciudad + '}';
    }
